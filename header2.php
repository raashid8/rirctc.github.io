    ...
    <nav class="navbar bg-dark navbar-dark navbar-expand-sm mb-1">
        ...
        <div class="navbar-collapse collapse" id="myNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a href="" class="nav-link"><?php echo $name ?></a></li>
    ...
    <nav class="navbar bg-primary navbar-dark navbar-expand-sm">
        ...
        <div class="navbar-collapse collapse" id="myNav">
            <ul class="navbar-nav ml-5">
                <li class="nav-item active"><a href="index.php" class="nav-link"><i class="fa fa-home"></i></a></li>
                <li class="nav-item dropdown active"><a href="" class="nav-link dropdown-toggle" data-toggle="dropdown">Trains</a>
                ...
                <li class="nav-item"><a href="stays.php" class="nav-link">Stays</a></li>
                 ...
                 <li class="nav-item" id="log"><a href="logout.php?logout=1" class="nav-link text-light ">Logout</a></li>
                <!-- <li class="nav-item" id="reg" ><a href="register.php" class="nav-link text-light">Register</a></li> -->
                <li class="nav-item" id="adminlog"><a href="Adminlogin.php" class="nav-link">Admin Login</a></li>
