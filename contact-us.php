...
<div id="contact" class="container bg-img">
  ...
  <div class="row bg-grey pt-3">
    <div class="col-sm-5">
      <p style="text-align:center; font-size: 32px;"> <b>Contact us</b></p>
      <p><span class="fa fa-map-marker"></span> 32/12 Periamet,<br>&nbsp;&nbsp;&nbsp;&nbsp;Chennai-950543,<br>&nbsp;&nbsp;&nbsp;&nbsp;India.</p>
      <p><span class="fa fa-phone"></span> +91 9900909099</p>
    ...
    <form action="" method="post" name="conForm" onsubmit="return(contactvalid());" class="col-sm-7 slideanim">
      ...
      <textarea class="form-control" id="msg" name="msg" placeholder="Comment" maxlength="250" rows="5"></textarea><br>
      <div class="row">
